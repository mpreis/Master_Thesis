...
% transformed trace
%
\node (trt label)   [node distance=2.5cm, below=of mat content.south]          {\trtLabel};
...
\node [below=of mat.south, yshift=0.9cm, xshift=1.5cm] {analysis \\ ~ \\ execution \& \\ transformation};
\end{tikzpicture}
