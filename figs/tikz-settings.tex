...
\tikzstyle{cache-load}=[draw=green, line width=1mm, rectangle, rounded corners, minimum size=4mm]
\tikzstyle{cache-store}=[fill=yellow, draw=yellow, line width=1mm, rectangle, rounded corners, minimum size=4mm]
\tikzstyle{memory-load}=[draw=orange, line width=1mm, circle]
\tikzstyle{memory-store}=[fill=red,draw=red, line width=1mm, circle]
